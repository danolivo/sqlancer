...
public final class PostgresCommon {
    ...
    private static void addFunctionErrors(ExpectedErrors errors) {
        ...
        /*
         * PostgreSQL support only a few conversion variants to ASCII:
         * LATIN1, LATIN2, LATIN9 and WINDOWS1250. So, it is better to skip this
         * error at all.
         */
        errors.addRegex(Pattern.compile("encoding conversion from \\w+ to ASCII not supported"));

        /*
         * In accordance with PostgreSQL code, commit 0ab1a2e, conversions to or
         * from SQL_ASCII is meaningless. So disable errors on such an attempt.
         */
